...
CREATE TABLE `ar` (
  ...
  `egyseg` varchar(255) COLLATE utf8_hungarian_ci DEFAULT NULL
...
CREATE TABLE `suti` (
  ...
  `tipus` varchar(255) COLLATE utf8_hungarian_ci DEFAULT NULL,
...
CREATE TABLE `tartalom` (
  ...
  `mentes` varchar(255) COLLATE utf8_hungarian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
